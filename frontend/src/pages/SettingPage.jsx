...
const PREVIEW_MESSAGES = [
  ...
  {
    id: 2,
    content: "Hi Dinith! How are you doing today?",
    isSent: true,
  },
];
...
const SettingsPage = () => {
  ...
  return (
    <div className="min-h-screen container mx-auto px-4 pt-20 max-w-6xl pb-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        
        {/* Left Side: Preview Section (Order 2 on mobile, Order 1 on desktop) */}
                ...
                <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-sm">Dinith Ankitha</h3>
        ...
        {/* Right Side: Theme Section (Order 1 on mobile, Order 2 on desktop) */}
